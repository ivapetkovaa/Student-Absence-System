...
public partial class Admin_AddStaff : System.Web.UI.Page
{
    ...
    protected void btnadd_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            StaffAdapter.Insert(txtname.Text, drpstd.SelectedItem.Text, txtemail.Text, txtmobile.Text, "NULL" , txtqual.Text, txtadd.Text, txtcity.Text, txtpin.Text, txtuname.Text, txtpass.Text,DropDownList1.SelectedItem.Text);
