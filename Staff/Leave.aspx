                                ...
                                <td>
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkapprove" runat="server" ForeColor="Blue" Text="Approve" CommandName="Approve" CommandArgument='<%#Eval("LID") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                ...
                                <td>
                                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                          ...
                                          <%--  <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkapprove0" runat="server" ForeColor="Blue" 
                                ...
                                <td>
                                    <asp:GridView ID="GridView3" runat="server" AutoGenerateColumns="False" 
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkapprove1" runat="server" ForeColor="Blue" 
                                                        Text="Approve" CommandName="Approve" CommandArgument='<%#Eval("LID") %>'></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <%-- <asp:TemplateField>
