...
public partial class Staff_AddStudent : System.Web.UI.Page
{
    ...
    protected void btnstuadd_Click(object sender, EventArgs e)
    {
            ...
            StuAdapter.Insert(txtroll.Text, txtname.Text, lblstd.Text, drpdiv.SelectedItem.Text, txtemail.Text, txtmobi.Text, bdate.GetDateTimeFormats()[8].ToString(), "NULL", txtadd.Text, txtcity.Text, txtpin.Text, txtuname.Text, txtpass.Text);
